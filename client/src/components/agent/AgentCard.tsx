...
const InfoBar = ({ icon, name }: InfoBarProps) => {
  return <Stack flex={1} minWidth={{xs: '100%', sm: 300}} gap={1.5} direction='row'>
    {icon}
  ...
  return (
    <Box
      ...
      sx={{
        ...
        padding: '20px',
        '&:hover': {
          boxShadow: '0 20px 45px 2px rgba(176, 176, 176, 0.1)'
        }
      }}
    >
      <img
      ...
      />
      <Stack direction='column' flex={1} gap={{ xs: 4, sm: 2 }}>
